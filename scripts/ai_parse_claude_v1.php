...
**bathrooms** (integer):
- Look for: "baños", "bathrooms", "bath"
- Example: "2 baños" → 2

**property_type** (string):
- Common types: villa, apartment, house, penthouse, townhouse, finca, duplex
- Example: "Villa independiente" → "villa"

**listing_type** (string: "sale" or "rent" only):
- "sale" for: venta, comprar, for sale, en venta
- "rent" for: alquiler, rental, for rent, to let

**address** (string, location of property):
- Look for: street address, city, zone, area
- Example: "Calle Mayor 123, Alicante"

**reference_id** (string, listing reference):
- Look for: "ref", "referencia", "código", "reference", "property id"
- Example: "Ref: ABC-12345"

**agent_name** (string):
- Agency or agent name
